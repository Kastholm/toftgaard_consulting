...
?><script>
  AOS.init();
</script><div class=loadingScreen><span class=loader><span class=loader-inner></span></span><div class=progress-bar><span class=bar><span class=progress></span></span></div></div><div class=banner><div class=bgOverlay><video id=bannerVideo autoplay muted loop playsinline>Your browser does not support the video tag.<source type=video/mp4 src=https://gpkollund.com/media/ncupoghm/23570_gp-kollund_website_background-overlay.mp4></video><div class=bannerBox><h1>Wilkommen bei Toftgaard Consulting</h1><h2>Wir kümmern uns um Sie</h2><div class=button-row><button class=btn-24>knap1</button> <button class=btn-24>knap2</button></div></div></div></div><div class=owl-slider><h3>Vi samarbejder med</h3><div class=corner></div><div class="owl-carousel owl-theme"><?php $Partnere = new WP_Query(array(
  'post_per_page' =>2, 'post_type' => 'samarbejdspartnere', 'order' => 'ASC' )); while($Partnere -> have_posts()) { $Partnere->the_post(); ?><div class="item itemTwo"><img width=200 height=150 src="<?php" echo the_post_thumbnail_url() ?> alt=<?php echo get_the_excerpt() ?>/></div><?php
}
?></div></div><div class=textField><div><h2>Speed and flexi bility that suits your needs</h2><div class=stats><div class="stats__item is-visible" data-module-reveal=up data-reveal-delay><div class=stats__content><p class=stats__stat>10</p><p class=stats__description>years of eCommerce sales growth in just 10 weeks</p></div></div><div class="stats__item is-visible" data-module-reveal=up data-reveal-delay><div class=stats__content><p class=stats__stat>51%</p><p class="stats__description margin-none">transportation cost savings with more flexible fulfillment locations</p></div></div></div></div><div><p>GP Kollund provides a broad variety of logistics solutions for both German and Danish customers. We value trust, speed, and flexibility in every business relation.<br><br>We cater both small and big companies, seasonal activities, and heavy, daily operations worth €1 million in pallets. Our success derives from an in-depth understanding of our customers’ logistic needs and a lean setup based on thirteen logistic units.<br><br>You can combine those thirteen units however you want, thanks to an agile drag-and-drop system. Learn more about the system here.<br>Together with years and years of experience, this adds up to process</p><button class=btn-24>aa</button></div></div><div class=serviceChoose><nav class=serviceToggle><span><p>Punkt 1</p><input type=checkbox class=checkOne checked></span> <span><p>Punkt 1</p><input type=checkbox class=checkTwo></span> <span><p>Punkt 1</p><input type=checkbox class=checkThree></span> <span><p>Punkt 1</p><input type=checkbox class=checkThree></span></nav><div class=serviceOutput><div data-aos=fade-down-left class=promo style="--overlay-color: #2e2b6e"><div class=image-wrapper><img class=toggleImg src="https://images.unsplash.com/photo-1554620121-59e7f3f6e3a4?ixlib=rb-1.2.1&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=800&amp;fit=max&amp;ixid=eyJhcHBfaWQiOjE0NTg5fQ"></div><h2 class=title data-cta="Get out there →">Nightlife</h2></div><div class=toggleText><h3>Titelfelt lorem ipsum</h3><h2></h2><p></p><button class=btn-24>se mere</button><div class=stats><div class="stats__item is-visible" data-module-reveal=up data-reveal-delay><div class=stats__content><p class=stats__stat>10</p><p class=stats__description>years of eCommerce sales growth in just 10 weeks</p></div></div><div class="stats__item is-visible" data-module-reveal=up data-reveal-delay><div class=stats__content><p class=stats__stat>51%</p><p class="stats__description margin-none">transportation cost savings with more flexible fulfillment locations</p></div></div></div></div></div></div><script>
...
</script><section id=our-solutions><div class=select-solutions><h2>Toftgaard Consulting</h2><div>fordele</div></div><div class=content><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/Resultatbaseret-analyser.webp><p>Resultatsbaseret analyser</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/No-cure-no-pay.webp><p>No cure - no pay</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/Eksperter-i-logistikoptimerisering.webp><p class=font-fix>Eksperter i logistik-optimisering</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/3000-implementeringer-live.webp><p>+3000 udførte implementeringer</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/10-30-besparelse-.webp><p>10-30% besparelse i transportomkostninger</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/Ingen-opstartsbetaling.webp><p>Ingen opstartbetalinger</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/Vi-star-for-fuld-implementering.webp><p>Vi står for fuld implementering</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/4-maneder-kvali.webp><p>24 md. kvalitetsopsyn efter implementering</p></div><div><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/Skaber-positivt-cashflow.webp><p>Skaber positivt cash-flow</p></div></div><button class=btn-24>aaaa</button></section><?php
the_content();
    ?><?php
get_footer()
?>