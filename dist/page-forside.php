...
</script><div class=boxContainer><div class=containerImg><span><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/bgeff.webp></span> <span data-aos=fade-down-right><img class=top-fix src=https://www.folklor-mersch.lu/images/sursite/Photos-Coming-Soon.jpg></span></div><div class=containerText><h2>Opdag dit potentiale</h2><p>Ikke alle potentielle kunder er overbevist om sit potentiale, og mange virksomheder har allerede truffet forskellige tiltag for at forbedre logistikken gennem årene, derfor er spørgsmålet vi ofte hører:<br><br>"Er det værd at tjekke ud?"<br><br>Ja, altid – et eksternt syn giver dig sikkerhed for, at din transport og logistik er sat korrekt op ift. din virksomhedstype. For at gøre denne proces nemmere tilbyder vi dig en hurtig analyse.</p><button class=btn-24>CTA</button></div></div><div class="boxContainer containerRight"><div class=containerImg><span><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/bgeff.webp></span> <span data-aos=fade-down-left><img src=https://www.folklor-mersch.lu/images/sursite/Photos-Coming-Soon.jpg></span></div><div class=containerText><h2>5%-15% stigning i EBIT</h2><p>Vi skaber en positiv dialog med jeres logistikafdelingen, og sammen med vores logistikeksperter reducerer vi dine logistikomkostninger med omkring 20% - med uændret kvalitet i forbindelse til jeres service/produkt.<br>Vores honorarer er i de fleste tilfælde succesbaserede, det giver flere væsentlige fordele i længden for dig.<br>Det er risikofrit og skaber positivt cashflow i din virksomhed.</p><button class=btn-24>CTA</button></div></div><script>
