...
?><script>
  AOS.init();
</script><div class=loadingScreen><span class=loader><span class=loader-inner></span></span><div class=progress-bar><span class=bar><span class=progress></span></span></div></div><div class=subBanner><span class="field text"><div class=border-top></div><span class=innertext><h1>Pallet-Management-System, bæredygtigt & effektivt</h1><h2>Vi har ikke kun gennem vores logistik-analyser men også gennem mere end 35 års erfaring inden for logistikbranchen set at paller i stigende grad udgør en meget vigtig del af virksomhedernes daglige drift, vores fokus ligger i at gøre det nemmere for vores kunder i dagligdagen – også når det gælder om paller.</h2></span></span> <span class="field img pm-banner"></span></div><div class=border-bot></div><script>
...
</script><div class=boxContainer><div class=containerImg><span><?php echo "<img src='".get_stylesheet_directory_uri()."/dist/img/bgeff.webp' \>" ?></span> <span data-aos=fade-down-right><?php echo "<img class='top-fix' src='".get_stylesheet_directory_uri()."/dist/img/pallebanner.webp' \>" ?></span></div><div class=containerText><h2>Pallet-Management-System</h2><p>Vi tilbyder et stærkt Pallet-Management-System (PMS) koncept hvor vi køber og sælger alle former for paller og altid er lagerførende<br>1. Engangspaller<br>2. paller<br>3. EURO Paller ( A, B, C og D standard)<br>4. Plastik / Kunstof Paller<br>5. Pallerammer</p><button class=btn-24>sup</button></div></div><?php
the_content();
    ?><?php
get_footer()
?>