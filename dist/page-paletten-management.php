...
?><script>
  AOS.init();
</script><div class=loadingScreen><span class=loader><span class=loader-inner></span></span><div class=progress-bar><span class=bar><span class=progress></span></span></div></div><div class=subBanner><span class="field text"><div class=border-top></div><span class=innertext><h1>Pallehåndtering, bæredygtigt & effektivt</h1><h2>Sammen med Gp>kollund's omfattende viden gennem mere end 20 år inden for Pallehåndtering, er vi i stand til at levere alt fra standardiserede paller til internationale paller samt restaurere, genbruge og udveksle klassificerede europæiske paller.</h2></span></span> <span style='background-image: url("https://i.ibb.co/jgt4MMj/Palleh-ndtering-h-ndtering-af-paller.jpg"); background-size: cover;' class="field img"></span></div><div class=border-bot></div><div class=serviceChoose><div class=box><span></span> <span></span> <span></span></div><nav data-aos=fade-up class=serviceToggle><span><p>Paller med værdi</p><input type=checkbox class=checkOne checked></span> <span><p>Miljøvenlige paller</p><input type=checkbox class=checkTwo></span> <span><p>Håndtering af paller</p><input type=checkbox class=checkThree></span></nav><div class=serviceOutput><div data-aos=fade-down-left class=promo style="--overlay-color: #2e2b6e"><div class=image-wrapper><img class=toggleImg src="https://images.unsplash.com/photo-1554620121-59e7f3f6e3a4?ixlib=rb-1.2.1&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=800&amp;fit=max&amp;ixid=eyJhcHBfaWQiOjE0NTg5fQ"></div><h2 class="title imgTitle"></h2></div><div class=toggleText><h3>Pallehåndtering</h3><h2></h2><p></p><a class=link href="https://gpkollund.com/"><button target=_blank class=btn-24>Gp>kollund</button></a><div class=stats><div class="stats__item is-visible" data-module-reveal=up data-reveal-delay><div class=stats__content><p data-aos=fade-up class="stats__stat statOne">10</p><p data-aos=fade-up class="stats__description statOneText">years of eCommerce sales growth in just 10 weeks</p></div></div><div class="stats__item is-visible" data-module-reveal=up data-reveal-delay><div class=stats__content><p data-aos=fade-up class="stats__stat statTwo">51%</p><p data-aos=fade-up class="stats__description margin-none statTwoText">transportation cost savings with more flexible fulfillment locations</p></div></div></div></div></div></div><script>
...
</script><div class=boxContainer><div class=containerImg><span><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/bgeff.webp></span> <span data-aos=fade-down-right><img src="https://gpkollund.com/media/whicq5ru/gp_kollund_210322_01216.jpg?rxy=0.577142144431048,0.3082922568166219&width=640&height=414&quality=90&rnd=132954515089170000"></span></div><div class=containerText><h2>Torben Prüss</h2><p>Administrerende direktør og ejer af Gp>kollund, Danmark<br><br>Mob: +45 2142 1795<br><br>E-mail: tp@gpkollund.dk</p><button class=btn-24>sup</button></div></div><h2><b>Mangler(Spørg H & T om de ønsker T & L fremvist)</b></h2><div class="boxContainer containerRight"><div class=containerImg><span><img src=http://localhost:8080/toftgaard_consulting/wp-content/uploads/2022/11/bgeff.webp></span> <span data-aos=fade-down-left><img src="https://gpkollund.com/media/xlih3lt0/gp_kollund_210322_01259.jpg?rxy=0.4653889327734586,0.31627877955949335&width=640&height=414&quality=90&rnd=132954514822100000"></span></div><div class=containerText><h2>Lars Vonderbank</h2><p>Administrerende direktør af Gp>kollund, Tyskland<br><br>Mob: +49 171 562 0388<br><br>E-mail: lv@gpkollund.dk</p><p></p><button class=btn-24>sup</button></div></div><?php
the_content();
    ?><?php
get_footer()
?>