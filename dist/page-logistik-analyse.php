...
imgBox.src = <?php echo "'".get_stylesheet_directory_uri()."/dist/img/cashfloww.webp'" ?>
   ...
   setTimeout(() => {
    ...
    field.classList.remove('opacityZ');
        ...
        statTwo.innerHTML = ''
        statTwoT.innerHTML = ``
        textBox.innerHTML = `Med vores attraktive kontrakt opnår i typisk en Return Of Investment allerede inden for de første 1-2 måneder. `
