...
?><script>
  AOS.init();
</script><div class=loadingScreen><span class=loader><span class=loader-inner></span></span><div class=progress-bar><span class=bar><span class=progress></span></span></div></div><div class=subBanner><span class="field text"><div class=border-top></div><span class=innertext><h1>Logistik Analyse, af jeres opsætning</h1><h2>Vi fokuserer på flere forskellige områder i virksomheden som er berørt af transport og logistik uagtet organisatoriske skillelinjer som f.eks. indkøb, supply chain eller logistik. Vi foretager en vurdering af de områder, hvor vi kan være nyttige til at supplere jeres viden og ekspertise. Vi arbejder tæt sammen med jer for at udvikle nye løsninger og aktivt støtte jer i den effektive implementering af løsningerne</h2></span></span> <span class="field img la-banner"></span></div><div class=border-bot></div><script>
...
link.href="quick-analyse";
        ...
        textBox.innerHTML = `Logistikomkostningerne udgør ofte en mindre del af virksomhedens totale omkostninger og får derfor
...
</script><div class=timeline-container id=timeline-1><div class=timeline-header><h2 class=timeline-header__title>Sådan foregår en Quick-Analyse</h2><h3 class=timeline-header__subtitle>7 skridt til din udvikling</h3></div><div class=timeline><div class=timeline-item data-text=1><div class=timeline__content><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt1.webp' \>" ?><h2 class=timeline__content-title>Fase 1</h2><p class=timeline__content-desc>Indhente informationer på det aktuelle set-up bl.a. strukturer, processer, kvalitet og behov.</p></div></div><div class=timeline-item data-text=2><div class=timeline__content><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt2.webp' \>" ?><h2 class=timeline__content-title>Fase 2</h2><p class=timeline__content-desc>Data validering herunder sendingsstatik, priser, transportører, vognpark, lager.</p></div></div><div class=timeline-item data-text=3><div class=timeline__content><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt3.webp' \>" ?><h2 class=timeline__content-title>Fase 3</h2><p class=timeline__content-desc>Analyse og Tender inden for de fastlagte områder.</p></div></div><div class=timeline-item data-text=4><div class=timeline__content><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt4.webp' \>" ?><h2 class=timeline__content-title>Fase 4</h2><p class=timeline__content-desc>Udarbejdelse af resultat fra vores analyser, observationer og tender.</p></div></div><div class=timeline-item data-text=5><div class=timeline__content><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt5.webp' \>" ?><h2 class=timeline__content-title>Fase 5</h2><p class=timeline__content-desc>Præsentation af resultater og beslutningsgrundlag.</p></div></div><div class=timeline-item data-text=6><div class=timeline__content><img class=timeline__img src=https://i.ibb.co/jwDmfZv/Logistik-analyse-punkt-5-7.jpg><h2 class=timeline__content-title>Fase 6</h2><p class=timeline__content-desc>Valg af nyt set-up ud fra præsentation og beslutningsgrundlag.</p></div></div><div class=timeline-item data-text=7><div class=timeline__content><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt6.webp' \>" ?><h2 class=timeline__content-title>Fase 7</h2><p class=timeline__content-desc>Implementering af nyt set-up samt start på 12 måneders løbende kvalitetskontrol</p></div></div></div></div><div class=demo-footer></div><script>
