...
<div class='subBanner'>
	...
	<span class='innertext'>
		<h1>Logistik Analyse, af jeres opsætning
</h1>
...
<div  style='border-top: 2px dotted black;' class='textField'>
...
<div ><h2 class='phone-header'  data-aos="fade-right">Få et dybdegående overblik</h2>
<div class='corner'> </div>

<p>
Vi fokuserer på flere forskellige områder i virksomheden som er berørt af transport og logistik uagtet
organisatoriske skillelinjer som f.eks. indkøb, supply chain eller logistik.<br>
Vi foretager en vurdering af de områder, hvor vi kan være nyttige til at supplere jeres viden og ekspertise.
Vi arbejder tæt sammen med jer for at udvikle nye løsninger og aktivt støtte jer i den effektive
implementering af løsningerne. <br> Procestiden for vores logistik analyse er omkring 4 måneder.
Analysen gennemføres med et hold af specialister med mere end 20 års erfaring.
</p>           
...
<div class='topPageInfo'>
  ...
  <b style='margin: 1em 0;'>Den omfatter typisk
følgende opgaver.</b>
<span>
  <div class='point'>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p> Analyse af det aktuelle logistik setup.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg> <p>Behovsanalyse og fastlæggelse af kvalitets standarder.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Logistik forløb med fokus på strukturer og processer.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Palle Management System (PMS).</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Emballage.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Transport- og Sendingsstatik analyse i vores data simulator.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Beregning og benchmark af nuværende og nye tilbud.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Tender Management - på transport- og logistikydelser.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Lager og kommissionerings opgaver.</p> 
</div>
<br>
<div class='point'>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M160 256C160 202.1 202.1 160 256 160C309 160 352 202.1 352 256C352 309 309 352 256 352C202.1 352 160 309 160 256zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z"/></svg><p>Analyse af egen vognpark (lastbiler) - eventuel make or buy.</p> 
</div>
<br>
</span>
...
<div class="timeline-container" id="timeline-1">
    ...
    <div class="timeline">
        <div class="timeline-item" data-text="1">
            <div class="timeline__content"><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt1.webp' \>" ?>
        ...
        <div class="timeline-item" data-text="2">
            <div class="timeline__content"><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt2.webp' \>" ?>
        ...
        <div class="timeline-item" data-text="3">
            <div class="timeline__content"><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt3.webp' \>" ?>
        ...
        <div class="timeline-item" data-text="4">
            <div class="timeline__content"><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt4.webp' \>" ?>
        ...
        <div class="timeline-item" data-text="5">
            <div class="timeline__content"><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt5.webp' \>" ?>
        ...
        <div class="timeline-item" data-text="7">
            <div class="timeline__content"><?php echo "<img class='timeline__img' src='".get_stylesheet_directory_uri()."/dist/img/punkt6.webp' \>" ?>
