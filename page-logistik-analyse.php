...
<section id="why-us">
      <div class="overlay">
        ...
        <p>
          Did you know, hours of hundreds of manhours are spent entering data which could be automatically captured?<br />
          Did you know, operational mistakes could have a cost in the tens of thousands of dollars?<br /> Did you know
          that your current port
        call operations are a black hole with no operational data being captured in a meaningful way?<br />
      </p>
      <p>
        The Constant Bearing App solves these problems by digitizing your port call operations down to the last detail.
        Through our app, you plan better, execute better and collect better data. Building this collaborative ecosystem
        means that every stakeholder
        plays a role in keeping your port call shipshape.<br /> Through better tools, Better outcomes.<br /> Coming soon
        on Mobile, Tablets and for your desktop.
      </p>
    </div>
    </section>
